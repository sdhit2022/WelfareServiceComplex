try {
    ...
    */
    ...
    var d_1options1 = {
      ...
      xaxis: {
          categories: ['فرو', 'ارد', 'خرد', 'تیر', 'مرد', 'شهر', 'مهر', 'آبان', 'آذر', 'دی', 'بهم', 'اسف'].reverse(),
      },
      fill: {
        type: 'gradient',
        gradient: {
...
var d_2options1 = {
  chart: {
    ...
    xaxis: {
        ...
        categories: ['شنبه', '1 شنبه', '2 شنبه', '3 شنبه', '4 شنبه', '5 شنبه', 'جمعه'].reverse(),
    },
    yaxis: {
        show: false
    },
...
var options1 = {
  ...
  labels: ['فرو', 'ارد', 'خرد', 'تیر', 'مرد', 'شهر', 'مهر', 'آبان', 'آذر', 'دی', 'بهم', 'اسف'].reverse(),
  xaxis: {
    axisBorder: {
      show: false
    },
